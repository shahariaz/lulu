...
**Document Status:** Superseded by `revision-03-report.md` (historical record)  
**Date:** 2026-09-09  
...
- **Acceptance Criteria:**
  - `node --test test/orchestrator-db.test.mjs` passes with behavior-focused tests covering migration idempotency, rollback/atomicity, foreign-key integrity, and non-destructive recovery branches.
