...
export class StorageRepository {
  ...
  async updateProjectAutonomyMode(id, mode) { throw new Error('Not implemented') }
  ...
  async listBaselines(projectId) { throw new Error('Not implemented') }
  ...
  async listProjectMilestones(projectId) { throw new Error('Not implemented') }
  ...
  // Features
  async createFeature(params) { throw new Error('Not implemented') }
  async getFeature(id) { throw new Error('Not implemented') }
  async listFeatures(epicId) { throw new Error('Not implemented') }
  async listProjectFeatures(projectId) { throw new Error('Not implemented') }
  async updateFeatureStatus(id, status) { throw new Error('Not implemented') }
  ...
  async listProjectTasks(projectId) { throw new Error('Not implemented') }
  ...
  async listTaskRuns(taskId) { throw new Error('Not implemented') }
  ...
  // Conversations
  async createConversation(params) { throw new Error('Not implemented') }
  async getConversation(id) { throw new Error('Not implemented') }
  async updateConversation(id, update) { throw new Error('Not implemented') }
  async addConversationMessage(params) { throw new Error('Not implemented') }
  async listConversationMessages(id) { throw new Error('Not implemented') }
...
export class SqliteStorageRepository extends StorageRepository {
  ...
  async updateProjectAutonomyMode(id, mode) {
    return updateProjectAutonomyMode(id, mode, this.db)
  }
  ...
  async listBaselines(projectId) {
    return listBaselines(projectId, this.db)
  }
  ...
  async listProjectMilestones(projectId) {
    return listProjectMilestones(projectId, this.db)
  }
  ...
  async createFeature(params) {
    return createFeature(params, this.db)
  }

  async getFeature(id) {
    return getFeature(id, this.db)
  }

  async listFeatures(epicId) {
    return listFeatures(epicId, this.db)
  }

  async listProjectFeatures(projectId) {
    return listProjectFeatures(projectId, this.db)
  }

  async updateFeatureStatus(id, status) {
    return updateFeatureStatus(id, status, this.db)
  }
  ...
  async listProjectTasks(projectId) {
    return listProjectTasks(projectId, this.db)
  }
  ...
  async listTaskRuns(taskId) {
    return listTaskRuns(taskId, this.db)
  }
  ...
  async createConversation(params) {
    return createConversation(params, this.db)
  }

  async getConversation(id) {
    return getConversation(id, this.db)
  }

  async updateConversation(id, update) {
    return updateConversation(id, update, this.db)
  }

  async addConversationMessage(params) {
    return addConversationMessage(params, this.db)
  }

  async listConversationMessages(id) {
    return listConversationMessages(id, this.db)
  }
